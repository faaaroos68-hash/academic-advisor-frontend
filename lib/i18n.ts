...
const en = {
  ...
  "dash.goodStanding": "Good standing",
  "dash.belowMinimum": "Below 2.0 minimum",
  "dash.cgpa": "CGPA",
  "dash.creditsEarned": "Credits Earned",
  "dash.recommendedLoad": "Recommended Load",
  "dash.basedOnGpa": "Based on GPA",
  "dash.degreeProgress": "Degree Progress",
  "dash.gpaTrend": "GPA Trend",
  "dash.gpaTrendEmpty": "GPA trend will appear once you complete graded terms.",
  "dash.aiRecommendations": "AI Recommendations",
  "dash.honorsCourses": "Consider honors courses",
  "dash.honorsCoursesDesc": "Your strong GPA makes you eligible for advanced coursework.",
  "dash.stayOnTrack": "Stay on track",
  "dash.stayOnTrackDesc": "You need {n} more credits to graduate.",
  "dash.useAiAdvisor": "Use the AI advisor",
  "dash.useAiAdvisorDesc": "Ask about course planning or graduation requirements.",
  "dash.academicWarning": "Academic Warning",
  "dash.academicWarningDesc": "Your GPA is below 2.0. Consider meeting with an advisor.",
...
const ar: typeof en = {
  ...
  "dash.goodStanding": "وضع جيد",
  "dash.belowMinimum": "أقل من الحد الأدنى 2.0",
  "dash.cgpa": "المعدل التراكمي",
  "dash.creditsEarned": "الساعات المكتسبة",
  "dash.recommendedLoad": "الحِمل الموصى به",
  "dash.basedOnGpa": "بناءً على المعدل",
  "dash.degreeProgress": "تقدم الحصول على الشهادة",
  "dash.gpaTrend": "اتجاه المعدل",
  "dash.gpaTrendEmpty": "سيظهر اتجاه المعدل بعد إكمال فترات دراسية بدرجات.",
  "dash.aiRecommendations": "توصيات الذكاء الاصطناعي",
  "dash.honorsCourses": "اختر مواد تميّز",
  "dash.honorsCoursesDesc": "معدلك العالي يؤهلك للدراسة المتقدمة.",
  "dash.stayOnTrack": "واصل المسار",
  "dash.stayOnTrackDesc": "تحتاج إلى {n} ساعة إضافية للتخرج.",
  "dash.useAiAdvisor": "استخدم مستشار الذكاء الاصطناعي",
  "dash.useAiAdvisorDesc": "اسأل عن التخطيط الأكاديمي أو متطلبات التخرج.",
  "dash.academicWarning": "تحذير أكاديمي",
  "dash.academicWarningDesc": "معدلك أقل من 2.0. يُنصح بمقابلة مستشار أكاديمي.",
  "dash.loading": "جارٍ تحميل ملفك الشخصي...",
  "dash.fall": "الخريف",
  "dash.spring": "الربيع",
  "dash.summer": "الصيف",
